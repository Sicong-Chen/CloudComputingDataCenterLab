...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.arp_table['10.0.0.1'] = ['00:00:00:00:ff:01']
        self.arp_table['10.0.0.2'] = ['00:00:00:00:ff:02']
        self.arp_table['10.0.0.3'] = ['00:00:00:00:ff:03']
        self.arp_table['10.0.0.4'] = ['00:00:00:00:ff:04']
    """
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1: # switch S1
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.2', 20, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 20, 4)
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.2', 10, 4)
            self.add_layer4_rules(datapath, inet.IPPROTO_ICMP, '10.0.0.4', 10, 4)
            ...
            self.add_layer4_rules(datapath, inet.IPPROTO_TCP, '10.0.0.4', 10, 4)
            ### implement icmp fwding
            ...
            math = parser.OFPMatch(eth_type = ether.ETH_TYPE_IP, ipv4_src = '10.0.0.2', ipv4_dst = '10.0.0.3', ip_proto = inet.IPPROTO_UDP)
            actions = []
            self.add_flow(datapath, 30, match, actions)
