...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        elif datapath.id == 2 and ipv4_pkt.proto == inet.IPPROTO_TCP:
        ...
        elif datapath.id == 3 and ipv4_pkt.proto == inet.IPPROTO_TCP:
        ...
        elif datapath.id == 4 and ipv4_pkt.proto == inet.IPPROTO_TCP:
